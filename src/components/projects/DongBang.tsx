  ...
  const data = {
    ...
    techStack: [
      ...
      },
      {
        title: "Docs",
        contents: [
          { name: "Notion", src: notion, isMine: true },
          { name: "Jira", src: jira, isMine: true },
          { name: "Figma", src: figma, isMine: true },
          { name: "ERD Cloud", src: erdcloud, isMine: false },
          { name: "PlantUML", src: plantUML, isMine: true },
          { name: "Lucid Chart", src: lucid, isMine: true },
        ],
      },
    ],
    images: [
